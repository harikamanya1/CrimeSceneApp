...
const CaseSelectionPage = ({ navigation }) => {
  ...
  const scenes = [
    // Sample scenes data, replace with actual data
    {
      title: "Scene 1",
      location: "Location 1",
      date: "Date 1",
  ...
  const handleExistingCase = () => {
    navigation.navigate("ExistingCasePage", { caseId, scenes });
  };

  return (
    <ImageBackground
      source={require("../assets/crime3.jpg")}
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          ...
          <Text style={styles.subtitle}>
            Or search for an existing case by ID
          </Text>
          <TextInput
            style={styles.input}
